...
/**
 * Даны целые числа 1<=n<=1E18 и 2<=m<=1E5, необходимо найти остаток от деления
 * n-го числа Фибоначчи на m. время
...
public class FiboC {
    ...
    /**
     * Решение сложно найти интуитивно. Возможно потребуется дополнительный поиск
     * информации. См. период Пизано
     */
