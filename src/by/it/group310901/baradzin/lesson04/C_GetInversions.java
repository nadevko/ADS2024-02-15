...
/**
 * <p>
 * Рассчитать число инверсий одномерного массива. Сложность алгоритма должна
 * быть не хуже, чем O(n log n)
 * </p>
 * <ol>
 * <li>Первая строка содержит число 1<=n<=10000,</li>
 * <li>вторая - массив A[1…n], содержащий натуральные числа, не превосходящие
 * 10E9.</li>
 * </ol>
 * <p>
 ...
 * массиве является в некотором смысле
 * его мерой неупорядоченности: например, в упорядоченном по неубыванию массиве
 * инверсий нет вообще, а в массиве,
 * упорядоченном по убыванию, инверсию образуют каждые (т.е. любые) два
 * элемента.
 * </p>
 * <p>
 * Sample Input:<br/>
 ...
 * </p>
 * <p>
 * Головоломка (т.е. не обязательно). Попробуйте обеспечить скорость лучше, чем
 * O(n log n) за счет многопоточности.
 * Докажите рост производительности замерами времени. Большой тестовый массив
 * можно прочитать свой или сгенерировать
 * его программно.
 * </p>
 */
