 ...
 * <li>сам массив A[1...n] из n различных натуральных чисел, не превышающих
 * 10E9, в порядке возрастания.</li>
 * </ol>
 * <p>
 * Во второй строке:
 * </p>
 ...
 * A[j]=b_i, или -1, если такого j нет.
 * </p>
 * <p>
 * Sample Input:<br/>
 * 5 1 5 8 12 13<br/>
 ...
 * 3 1 -1 1 -1<br/>
 * <p>
 * (!) Обратите внимание на смещение начала индекса массивов JAVA относительно
 * условий задачи
 * </p>
 */
    ...
    int[] findIndex(InputStream stream) {
        try (var scanner = new Scanner(stream)) {
            ...
            for (var i = 0; i < result.length; i++)
                result[i] = find(a, scanner.nextInt());
            return result;
        }
    }
