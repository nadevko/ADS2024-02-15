 ...
 * </p>
 * <p>
 * По данным файла (непустой строке ss длины не более 104104), состоящей из
 * строчных букв латинского алфавита,
 * постройте оптимальный по суммарной длине беспрефиксный код.
 * </p>
 * <p>
 * Используйте Алгоритм Хаффмана — жадный алгоритм оптимального безпрефиксного
 * кодирования алфавита с минимальной
 * избыточностью.
 * </p>
 * <p>
 * В первой строке выведите количество различных букв kk, встречающихся в
 * строке, и размер получившейся
 * закодированной строки. В следующих kk строках запишите коды букв в формате
 * "letter: code". В последней строке
...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
        try (var scanner = new Scanner(file)) {
            ...
            input.chars().forEach(symbol -> symbols.compute((char) symbol,
                    (key, frequency) -> (frequency == null ? 0 : frequency) + 1));
